...
begin
  ...
  -- Record security notification in admin_notifications table
...
-- 4. RPC to check if an admin account exists and whether it requires first-time password activation
