  ...
  Future<void> _handleSignUp() async {
    ...
    if (password != confirmPassword) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Hindi Tugma ang iyong Password',
            style: TextStyle(
              color: Colors.white,
              fontSize: 14,
              fontWeight: FontWeight.w500,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  role == 'partner'
                      ? 'Gumawa ng bagong account para magsimula bilang Partner Investor.'
                      : role == 'cashier'
                          ? 'Gumawa ng bagong account para magsimula bilang Cashier / POS Staff.'
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isLoading
                        ...
                        : Text(
                            role == 'partner'
                                ? 'Mag-Register bilang Partner'
                                : role == 'cashier'
                                    ? 'Mag-Register bilang Cashier'
                                    : 'Mag-Register bilang Raiser',
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        role == 'partner'
                            ? 'Mag-Login bilang Partner'
                            : role == 'cashier'
                                ? 'Mag-Login bilang Cashier'
                                : 'Mag-Login bilang Raiser',
